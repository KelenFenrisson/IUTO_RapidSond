#!/usr/bin/env python
# encoding: utf-8
# Généré par Mocodo 2.3.7 le Mon, 03 Apr 2017 19:46:03
...
(width,height) = (1180,702)
cx = {
    u"TYPE_QUESTION"           :   86,
    u"AVOIR_TYPE_QUESTION"     :  284,
    u"QUESTION"                :  478,
    u"ASSOCIER"                :  668,
    u"CHOIX_MULTIPLE"          :  883,
    u"CONSTITUER"              :  478,
    u"CONCERNER"               :  284,
    u"QUESTIONNAIRE"           :  478,
    u"ACHETER"                 :  668,
    ...
    u"REMPLIR"                 :  478,
    u"ENTREPRISE"              :  668,
    u"ENTREPRISE_AVOIR_ADRESSE":  883,
    u"VILLE"                   : 1098,
    u"APPARTENIR"              :  284,
    u"SONDE"                   :  478,
    u"SONDE_AVOIR_ADRESSE"     :  668,
    u"ADRESSE"                 :  883,
    u"ETRE_DANS"               : 1098,
    u"FAIRE_PARTIE"            :  478,
    u"CSP"                     :  668,
...
cy = {
    ...
    u"REMPLIR"                 :  398,
    u"ENTREPRISE"              :  398,
    u"ENTREPRISE_AVOIR_ADRESSE":  398,
    u"VILLE"                   :  398,
    u"APPARTENIR"              :  537,
    u"SONDE"                   :  537,
    u"SONDE_AVOIR_ADRESSE"     :  537,
    u"ADRESSE"                 :  537,
    u"ETRE_DANS"               :  537,
    u"FAIRE_PARTIE"            :  658,
    u"CSP"                     :  658,
...
lines += u"""\n\n<!-- Association REMPLIR -->"""
(x,y) = (cx[u"REMPLIR"],cy[u"REMPLIR"])
(ex,ey) = (cx[u"SONDE"],cy[u"SONDE"])
leg=straight_leg_factory(ex,ey,69,71,x,y,67,35,23+2*card_margin,14+2*card_margin)
lines += u"""\n<line x1="%(ex)s" y1="%(ey)s" x2="%(ax)s" y2="%(ay)s" stroke="%(stroke_color)s" stroke-width="1"/>""" % {'ex': ex, 'ey': ey, 'ax': x, 'ay': y, 'stroke_color': colors['leg_stroke_color']}
(tx,ty)=offset(*leg.card_pos(False,shift[u"REMPLIR,SONDE"]))
lines += u"""\n<text x="%(tx)s" y="%(ty)s" fill="%(text_color)s" font-family="Courier New" font-size="12">0,N</text>""" % {'tx': tx, 'ty': ty, 'text_color': colors['card_text_color']}
(ex,ey) = (cx[u"QUESTIONNAIRE"],cy[u"QUESTIONNAIRE"])
leg=straight_leg_factory(ex,ey,115,62,x,y,67,35,23+2*card_margin,14+2*card_margin)
lines += u"""\n<line x1="%(ex)s" y1="%(ey)s" x2="%(ax)s" y2="%(ay)s" stroke="%(stroke_color)s" stroke-width="1"/>""" % {'ex': ex, 'ey': ey, 'ax': x, 'ay': y, 'stroke_color': colors['leg_stroke_color']}
(tx,ty)=offset(*leg.card_pos(False,shift[u"REMPLIR,QUESTIONNAIRE"]))
lines += u"""\n<text x="%(tx)s" y="%(ty)s" fill="%(text_color)s" font-family="Courier New" font-size="12">0,N</text>""" % {'tx': tx, 'ty': ty, 'text_color': colors['card_text_color']}
lines += u"""\n<g id="association-REMPLIR">""" % {}
path = upper_round_rect(-67+x,-35+y,134,26,14)
lines += u"""\n	<path d="%(path)s" fill="%(color)s" stroke="%(stroke_color)s" stroke-width="0"/>""" % {'path': path, 'color': colors['association_cartouche_color'], 'stroke_color': colors['association_cartouche_color']}
path = lower_round_rect(-67+x,-9.0+y,134,44,14)
lines += u"""\n	<path d="%(path)s" fill="%(color)s" stroke="%(stroke_color)s" stroke-width="0"/>""" % {'path': path, 'color': colors['association_color'], 'stroke_color': colors['association_color']}
lines += u"""\n	<rect x="%(x)s" y="%(y)s" width="134" height="70" fill="%(color)s" rx="14" stroke="%(stroke_color)s" stroke-width="1.5"/>""" % {'x': -67+x, 'y': -35+y, 'color': colors['transparent_color'], 'stroke_color': colors['association_stroke_color']}
lines += u"""\n	<line x1="%(x0)s" y1="%(y0)s" x2="%(x1)s" y2="%(y1)s" stroke="%(stroke_color)s" stroke-width="1"/>""" % {'x0': -67+x, 'y0': -9+y, 'x1': 67+x, 'y1': -9+y, 'stroke_color': colors['association_stroke_color']}
lines += u"""\n	<text x="%(x)s" y="%(y)s" fill="%(text_color)s" font-family="Courier New" font-size="14">REMPLIR</text>""" % {'x': -30+x, 'y': -16.4+y, 'text_color': colors['association_cartouche_text_color']}
lines += u"""\n	<text x="%(x)s" y="%(y)s" fill="%(text_color)s" font-family="Courier New" font-size="14">id_utilisateur</text>""" % {'x': -60+x, 'y': 9.6+y, 'text_color': colors['association_attribute_text_color']}
lines += u"""\n	<text x="%(x)s" y="%(y)s" fill="%(text_color)s" font-family="Courier New" font-size="14">date</text>""" % {'x': -60+x, 'y': 27.6+y, 'text_color': colors['association_attribute_text_color']}
lines += u"""\n</g>""" % {}
...
(ex,ey) = (cx[u"QUESTIONNAIRE"],cy[u"QUESTIONNAIRE"])
leg=straight_leg_factory(ex,ey,115,62,x,y,37,26,23+2*card_margin,14+2*card_margin)
lines += u"""\n<line x1="%(ex)s" y1="%(ey)s" x2="%(ax)s" y2="%(ay)s" stroke="%(stroke_color)s" stroke-width="1"/>""" % {'ex': ex, 'ey': ey, 'ax': x, 'ay': y, 'stroke_color': colors['leg_stroke_color']}
...
lines += u"""\n<text x="%(tx)s" y="%(ty)s" fill="%(text_color)s" font-family="Courier New" font-size="12">1,1</text>""" % {'tx': tx, 'ty': ty, 'text_color': colors['card_text_color']}
(ex,ey) = (cx[u"QUESTIONNAIRE"],cy[u"QUESTIONNAIRE"])
leg=straight_leg_factory(ex,ey,115,62,x,y,50,26,23+2*card_margin,14+2*card_margin)
lines += u"""\n<line x1="%(ex)s" y1="%(ey)s" x2="%(ax)s" y2="%(ay)s" stroke="%(stroke_color)s" stroke-width="1"/>""" % {'ex': ex, 'ey': ey, 'ax': x, 'ay': y, 'stroke_color': colors['leg_stroke_color']}
...
(ex,ey) = (cx[u"QUESTIONNAIRE"],cy[u"QUESTIONNAIRE"])
leg=straight_leg_factory(ex,ey,115,62,x,y,46,26,23+2*card_margin,14+2*card_margin)
lines += u"""\n<line x1="%(ex)s" y1="%(ey)s" x2="%(ax)s" y2="%(ay)s" stroke="%(stroke_color)s" stroke-width="1"/>""" % {'ex': ex, 'ey': ey, 'ax': x, 'ay': y, 'stroke_color': colors['leg_stroke_color']}
...
lines += u"""\n		<rect x="%(x)s" y="%(y)s" width="230" height="26" fill="%(color)s" stroke="%(stroke_color)s" stroke-width="0"/>""" % {'x': -115+x, 'y': -62+y, 'color': colors['entity_cartouche_color'], 'stroke_color': colors['entity_cartouche_color']}
lines += u"""\n		<rect x="%(x)s" y="%(y)s" width="230" height="98" fill="%(color)s" stroke="%(stroke_color)s" stroke-width="0"/>""" % {'x': -115+x, 'y': -36.0+y, 'color': colors['entity_color'], 'stroke_color': colors['entity_color']}
lines += u"""\n		<rect x="%(x)s" y="%(y)s" width="230" height="124" fill="%(color)s" stroke="%(stroke_color)s" stroke-width="1.5"/>""" % {'x': -115+x, 'y': -62+y, 'color': colors['transparent_color'], 'stroke_color': colors['entity_stroke_color']}
lines += u"""\n		<line x1="%(x0)s" y1="%(y0)s" x2="%(x1)s" y2="%(y1)s" stroke="%(stroke_color)s" stroke-width="1"/>""" % {'x0': -115+x, 'y0': -36+y, 'x1': 115+x, 'y1': -36+y, 'stroke_color': colors['entity_stroke_color']}
lines += u"""\n	</g>""" % {}
lines += u"""\n	<text x="%(x)s" y="%(y)s" fill="%(text_color)s" font-family="Courier New" font-size="14">QUESTIONNAIRE</text>""" % {'x': -55+x, 'y': -43.4+y, 'text_color': colors['entity_cartouche_text_color']}
lines += u"""\n	<text x="%(x)s" y="%(y)s" fill="%(text_color)s" font-family="Courier New" font-size="14">id_questionnaire</text>""" % {'x': -110+x, 'y': -17.4+y, 'text_color': colors['entity_attribute_text_color']}
lines += u"""\n	<line x1="%(x0)s" y1="%(y0)s" x2="%(x1)s" y2="%(y1)s" stroke="%(stroke_color)s" stroke-width="1"/>""" % {'x0': -110+x, 'y0': -15.0+y, 'x1': 26+x, 'y1': -15.0+y, 'stroke_color': colors['entity_attribute_text_color']}
lines += u"""\n	<text x="%(x)s" y="%(y)s" fill="%(text_color)s" font-family="Courier New" font-size="14">intitule_questionnaire</text>""" % {'x': -110+x, 'y': 0.6+y, 'text_color': colors['entity_attribute_text_color']}
lines += u"""\n	<text x="%(x)s" y="%(y)s" fill="%(text_color)s" font-family="Courier New" font-size="14">dateheurelim_questionnaire</text>""" % {'x': -110+x, 'y': 18.6+y, 'text_color': colors['entity_attribute_text_color']}
lines += u"""\n	<text x="%(x)s" y="%(y)s" fill="%(text_color)s" font-family="Courier New" font-size="14">accessible_questionnaire</text>""" % {'x': -110+x, 'y': 36.6+y, 'text_color': colors['entity_attribute_text_color']}
lines += u"""\n	<text x="%(x)s" y="%(y)s" fill="%(text_color)s" font-family="Courier New" font-size="14">termine_questionnaire</text>""" % {'x': -110+x, 'y': 54.6+y, 'text_color': colors['entity_attribute_text_color']}
lines += u"""\n</g>""" % {}
...
with codecs.open("mcd_global_arranged.svg", "w", "utf8") as f:
    f.write(lines)
safe_print_for_PHP(u'Fichier de sortie "mcd_global_arranged.svg" généré avec succès.')