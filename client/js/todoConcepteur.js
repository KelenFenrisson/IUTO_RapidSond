function accueilConcepteur(){
		...
		$("#main").empty();
		$("#main").append('<input type="submit" value="Créer un nouveau sondage" class="btn btn-primary btn-lg active top-10 col-md-offset-3 col-md-6 bot-10" onclick="creerFormulaire()">');
